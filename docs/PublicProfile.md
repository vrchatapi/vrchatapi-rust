...
**background_gradient_bottom** | Option<**String**> | Hex colour without a leading `#`. | [optional]
**background_gradient_top** | Option<**String**> | Hex colour without a leading `#`. | [optional]
