...
**creation_languages** | Option<**Vec<serde_json::Value>**> |  | [optional]
...
**language_ratio** | Option<**std::collections::HashMap<String, serde_json::Value>**> |  | [optional]
**languages** | Option<**Vec<String>**> | The keys of languageRatio, ordered by their share of the instance. | [optional]
**languages_iso639** | Option<**Vec<String>**> |  | [optional]
...
**minimum_avatar_performance** | Option<**String**> |  | [optional]
**n_users** | **i32** |  | 
**name** | **String** |  | 
...
**user_count** | **i32** |  | 
**user_icons** | Option<**Vec<String>**> |  | [optional]
