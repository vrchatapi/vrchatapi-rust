...
pub async fn get_assigned_permissions(configuration: &configuration::Configuration, ) -> Result<Vec<models::Permission>, Error<GetAssignedPermissionsError>> {
...
pub async fn get_permission(configuration: &configuration::Configuration, permission_id: &str) -> Result<models::Permission, Error<GetPermissionError>> {
    let local_var_configuration = configuration;
