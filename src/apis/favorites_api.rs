...
pub fn add_favorite(configuration: &configuration::Configuration, inline_object7: Option<crate::models::InlineObject7>) -> Result<crate::models::Favorite, Error<AddFavoriteError>> {
...
pub fn update_favorite_group(configuration: &configuration::Configuration, favorite_group_type: &str, favorite_group_name: &str, user_id: &str, inline_object8: Option<crate::models::InlineObject8>) -> Result<(), Error<UpdateFavoriteGroupError>> {
