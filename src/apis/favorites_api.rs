...
pub async fn add_favorite(configuration: &configuration::Configuration, add_favorite_request: Option<models::AddFavoriteRequest>) -> Result<models::Favorite, Error<AddFavoriteError>> {
...
pub async fn clear_favorite_group(configuration: &configuration::Configuration, favorite_group_type: &str, favorite_group_name: &str, user_id: &str) -> Result<models::Success, Error<ClearFavoriteGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn get_favorite(configuration: &configuration::Configuration, favorite_id: &str) -> Result<models::Favorite, Error<GetFavoriteError>> {
    let local_var_configuration = configuration;
...
pub async fn get_favorite_group(configuration: &configuration::Configuration, favorite_group_type: &str, favorite_group_name: &str, user_id: &str) -> Result<models::FavoriteGroup, Error<GetFavoriteGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn get_favorite_groups(configuration: &configuration::Configuration, n: Option<i32>, offset: Option<i32>, owner_id: Option<&str>) -> Result<Vec<models::FavoriteGroup>, Error<GetFavoriteGroupsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_favorites(configuration: &configuration::Configuration, n: Option<i32>, offset: Option<i32>, r#type: Option<&str>, tag: Option<&str>) -> Result<Vec<models::Favorite>, Error<GetFavoritesError>> {
    let local_var_configuration = configuration;
...
pub async fn remove_favorite(configuration: &configuration::Configuration, favorite_id: &str) -> Result<models::Success, Error<RemoveFavoriteError>> {
    let local_var_configuration = configuration;
...
pub async fn update_favorite_group(configuration: &configuration::Configuration, favorite_group_type: &str, favorite_group_name: &str, user_id: &str, update_favorite_group_request: Option<models::UpdateFavoriteGroupRequest>) -> Result<(), Error<UpdateFavoriteGroupError>> {
    let local_var_configuration = configuration;
