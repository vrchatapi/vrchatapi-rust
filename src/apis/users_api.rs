...
pub async fn get_user_group_requests(configuration: &configuration::Configuration, user_id: &str) -> Result<Vec<models::Group>, Error<GetUserGroupRequestsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_user_groups(configuration: &configuration::Configuration, user_id: &str) -> Result<Vec<models::LimitedUserGroups>, Error<GetUserGroupsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_user_represented_group(configuration: &configuration::Configuration, user_id: &str) -> Result<models::RepresentedGroup, Error<GetUserRepresentedGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn search_users(configuration: &configuration::Configuration, search: Option<&str>, developer_type: Option<&str>, n: Option<i32>, offset: Option<i32>) -> Result<Vec<models::LimitedUser>, Error<SearchUsersError>> {
    let local_var_configuration = configuration;
...
pub async fn update_user(configuration: &configuration::Configuration, user_id: &str, update_user_request: Option<models::UpdateUserRequest>) -> Result<models::CurrentUser, Error<UpdateUserError>> {
    let local_var_configuration = configuration;
