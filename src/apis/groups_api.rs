...
pub async fn add_group_gallery_image(configuration: &configuration::Configuration, group_id: &str, group_gallery_id: &str, add_group_gallery_image_request: models::AddGroupGalleryImageRequest) -> Result<models::GroupGalleryImage, Error<AddGroupGalleryImageError>> {
...
pub async fn add_group_post(configuration: &configuration::Configuration, group_id: &str, create_group_post_request: models::CreateGroupPostRequest) -> Result<models::GroupPost, Error<AddGroupPostError>> {
    let local_var_configuration = configuration;
...
pub async fn ban_group_member(configuration: &configuration::Configuration, group_id: &str, ban_group_member_request: models::BanGroupMemberRequest) -> Result<models::GroupMember, Error<BanGroupMemberError>> {
    let local_var_configuration = configuration;
...
pub async fn create_group(configuration: &configuration::Configuration, create_group_request: models::CreateGroupRequest) -> Result<models::Group, Error<CreateGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn create_group_announcement(configuration: &configuration::Configuration, group_id: &str, create_group_announcement_request: models::CreateGroupAnnouncementRequest) -> Result<models::GroupAnnouncement, Error<CreateGroupAnnouncementError>> {
    let local_var_configuration = configuration;
...
pub async fn create_group_gallery(configuration: &configuration::Configuration, group_id: &str, create_group_gallery_request: models::CreateGroupGalleryRequest) -> Result<models::GroupGallery, Error<CreateGroupGalleryError>> {
    let local_var_configuration = configuration;
...
pub async fn create_group_invite(configuration: &configuration::Configuration, group_id: &str, create_group_invite_request: models::CreateGroupInviteRequest) -> Result<(), Error<CreateGroupInviteError>> {
    let local_var_configuration = configuration;
...
/// Create a Group role.
pub async fn create_group_role(configuration: &configuration::Configuration, group_id: &str, create_group_role_request: models::CreateGroupRoleRequest) -> Result<models::GroupRole, Error<CreateGroupRoleError>> {
    let local_var_configuration = configuration;
...
/// Deletes a Group.
pub async fn delete_group(configuration: &configuration::Configuration, group_id: &str) -> Result<models::Success, Error<DeleteGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_group_announcement(configuration: &configuration::Configuration, group_id: &str) -> Result<models::Success, Error<DeleteGroupAnnouncementError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_group_gallery(configuration: &configuration::Configuration, group_id: &str, group_gallery_id: &str) -> Result<models::Success, Error<DeleteGroupGalleryError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_group_gallery_image(configuration: &configuration::Configuration, group_id: &str, group_gallery_id: &str, group_gallery_image_id: &str) -> Result<models::Success, Error<DeleteGroupGalleryImageError>> {
    let local_var_configuration = configuration;
...
/// Delete a Group post
pub async fn delete_group_post(configuration: &configuration::Configuration, group_id: &str, notification_id: &str) -> Result<models::Success, Error<DeleteGroupPostError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_group_role(configuration: &configuration::Configuration, group_id: &str, group_role_id: &str) -> Result<Vec<models::GroupRole>, Error<DeleteGroupRoleError>> {
    let local_var_configuration = configuration;
...
pub async fn get_group(configuration: &configuration::Configuration, group_id: &str, include_roles: Option<bool>) -> Result<models::Group, Error<GetGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn get_group_announcements(configuration: &configuration::Configuration, group_id: &str) -> Result<models::GroupAnnouncement, Error<GetGroupAnnouncementsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_group_audit_logs(configuration: &configuration::Configuration, group_id: &str, n: Option<i32>, offset: Option<i32>, start_date: Option<String>, end_date: Option<String>) -> Result<models::PaginatedGroupAuditLogEntryList, Error<GetGroupAuditLogsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_group_bans(configuration: &configuration::Configuration, group_id: &str, n: Option<i32>, offset: Option<i32>) -> Result<Vec<models::GroupMember>, Error<GetGroupBansError>> {
    let local_var_configuration = configuration;
...
pub async fn get_group_gallery_images(configuration: &configuration::Configuration, group_id: &str, group_gallery_id: &str, n: Option<i32>, offset: Option<i32>, approved: Option<bool>) -> Result<Vec<models::GroupGalleryImage>, Error<GetGroupGalleryImagesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_group_instances(configuration: &configuration::Configuration, group_id: &str) -> Result<Vec<models::GroupInstance>, Error<GetGroupInstancesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_group_invites(configuration: &configuration::Configuration, group_id: &str, n: Option<i32>, offset: Option<i32>) -> Result<Vec<models::GroupMember>, Error<GetGroupInvitesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_group_member(configuration: &configuration::Configuration, group_id: &str, user_id: &str) -> Result<models::GroupLimitedMember, Error<GetGroupMemberError>> {
    let local_var_configuration = configuration;
...
pub async fn get_group_permissions(configuration: &configuration::Configuration, group_id: &str) -> Result<Vec<models::GroupPermission>, Error<GetGroupPermissionsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_group_post(configuration: &configuration::Configuration, group_id: &str, n: Option<i32>, offset: Option<i32>, public_only: Option<bool>) -> Result<models::GroupPost, Error<GetGroupPostError>> {
    let local_var_configuration = configuration;
...
pub async fn get_group_requests(configuration: &configuration::Configuration, group_id: &str, n: Option<i32>, offset: Option<i32>, blocked: Option<bool>) -> Result<Vec<models::GroupMember>, Error<GetGroupRequestsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_group_roles(configuration: &configuration::Configuration, group_id: &str) -> Result<Vec<models::GroupRole>, Error<GetGroupRolesError>> {
    let local_var_configuration = configuration;
...
pub async fn join_group(configuration: &configuration::Configuration, group_id: &str) -> Result<models::GroupMember, Error<JoinGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn respond_group_join_request(configuration: &configuration::Configuration, group_id: &str, user_id: &str, respond_group_join_request: models::RespondGroupJoinRequest) -> Result<(), Error<RespondGroupJoinRequestError>> {
    let local_var_configuration = configuration;
...
pub async fn search_groups(configuration: &configuration::Configuration, query: Option<&str>, offset: Option<i32>, n: Option<i32>) -> Result<Vec<models::LimitedGroup>, Error<SearchGroupsError>> {
    let local_var_configuration = configuration;
...
pub async fn unban_group_member(configuration: &configuration::Configuration, group_id: &str, user_id: &str) -> Result<models::GroupMember, Error<UnbanGroupMemberError>> {
    let local_var_configuration = configuration;
...
pub async fn update_group(configuration: &configuration::Configuration, group_id: &str, update_group_request: Option<models::UpdateGroupRequest>) -> Result<models::Group, Error<UpdateGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn update_group_gallery(configuration: &configuration::Configuration, group_id: &str, group_gallery_id: &str, update_group_gallery_request: Option<models::UpdateGroupGalleryRequest>) -> Result<models::GroupGallery, Error<UpdateGroupGalleryError>> {
    let local_var_configuration = configuration;
...
pub async fn update_group_member(configuration: &configuration::Configuration, group_id: &str, user_id: &str, update_group_member_request: Option<models::UpdateGroupMemberRequest>) -> Result<models::GroupLimitedMember, Error<UpdateGroupMemberError>> {
    let local_var_configuration = configuration;
...
/// Edits a Group post
pub async fn update_group_post(configuration: &configuration::Configuration, group_id: &str, notification_id: &str, create_group_post_request: models::CreateGroupPostRequest) -> Result<models::GroupPost, Error<UpdateGroupPostError>> {
    let local_var_configuration = configuration;
...
pub async fn update_group_role(configuration: &configuration::Configuration, group_id: &str, group_role_id: &str, update_group_role_request: Option<models::UpdateGroupRoleRequest>) -> Result<Vec<models::GroupRole>, Error<UpdateGroupRoleError>> {
    let local_var_configuration = configuration;
