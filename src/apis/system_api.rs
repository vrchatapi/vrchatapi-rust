...
pub async fn get_config(configuration: &configuration::Configuration, ) -> Result<models::ApiConfig, Error<GetConfigError>> {
...
pub async fn get_health(configuration: &configuration::Configuration, ) -> Result<models::ApiHealth, Error<GetHealthError>> {
    let local_var_configuration = configuration;
...
pub async fn get_info_push(configuration: &configuration::Configuration, require: Option<&str>, include: Option<&str>) -> Result<Vec<models::InfoPush>, Error<GetInfoPushError>> {
    let local_var_configuration = configuration;
