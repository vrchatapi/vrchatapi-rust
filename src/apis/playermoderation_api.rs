...
pub async fn clear_all_player_moderations(configuration: &configuration::Configuration, ) -> Result<models::Success, Error<ClearAllPlayerModerationsError>> {
...
pub async fn delete_player_moderation(configuration: &configuration::Configuration, player_moderation_id: &str) -> Result<models::Success, Error<DeletePlayerModerationError>> {
    let local_var_configuration = configuration;
...
pub async fn get_player_moderation(configuration: &configuration::Configuration, player_moderation_id: &str) -> Result<models::PlayerModeration, Error<GetPlayerModerationError>> {
    let local_var_configuration = configuration;
...
pub async fn get_player_moderations(configuration: &configuration::Configuration, r#type: Option<&str>, target_user_id: Option<&str>) -> Result<Vec<models::PlayerModeration>, Error<GetPlayerModerationsError>> {
    let local_var_configuration = configuration;
...
pub async fn moderate_user(configuration: &configuration::Configuration, moderate_user_request: models::ModerateUserRequest) -> Result<models::PlayerModeration, Error<ModerateUserError>> {
    let local_var_configuration = configuration;
...
pub async fn unmoderate_user(configuration: &configuration::Configuration, moderate_user_request: models::ModerateUserRequest) -> Result<models::Success, Error<UnmoderateUserError>> {
    let local_var_configuration = configuration;
