...
pub async fn close_instance(configuration: &configuration::Configuration, world_id: &str, instance_id: &str, hard_close: Option<bool>, closed_at: Option<String>) -> Result<models::Instance, Error<CloseInstanceError>> {
...
/// Create an instance
pub async fn create_instance(configuration: &configuration::Configuration, create_instance_request: models::CreateInstanceRequest) -> Result<models::Instance, Error<CreateInstanceError>> {
    let local_var_configuration = configuration;
...
pub async fn get_instance(configuration: &configuration::Configuration, world_id: &str, instance_id: &str) -> Result<models::Instance, Error<GetInstanceError>> {
    let local_var_configuration = configuration;
...
pub async fn get_instance_by_short_name(configuration: &configuration::Configuration, short_name: &str) -> Result<models::Instance, Error<GetInstanceByShortNameError>> {
    let local_var_configuration = configuration;
...
pub async fn get_short_name(configuration: &configuration::Configuration, world_id: &str, instance_id: &str) -> Result<models::InstanceShortNameResponse, Error<GetShortNameError>> {
    let local_var_configuration = configuration;
...
pub async fn send_self_invite(configuration: &configuration::Configuration, world_id: &str, instance_id: &str) -> Result<models::Success, Error<SendSelfInviteError>> {
    let local_var_configuration = configuration;
